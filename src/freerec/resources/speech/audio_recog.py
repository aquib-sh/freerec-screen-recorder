...
class Recognizer(AudioSource):
    def __init__(self):
        ...
        self.toggle_stop = False    # use this variable to stop the record function in betweeen, using a seperate thread assign this value to True from your main file in order to stop the record and return Audio Data
    ...
    def record(self, source, duration=None, offset=None):
        ...
        while True:  # loop for the total number of chunks needed
            ...
            if offset_reached or not offset:
                ...
                frames.write(buffer)
            # If toggle_stop is enabled then stop recording and return
